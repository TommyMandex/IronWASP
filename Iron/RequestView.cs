    ...
    public partial class RequestView : UserControl
    {
        ...
        public void ClearRequest()
        {
            if (!LoadingRequest)
            {
                ...
                this.ClearData();
                this.ShowHideEmptyMessages();
            }
            else
            {
                ShowStatusMsg("Loading a Request is already in progress!");
            }
        }
        ...
        void SetBodyParameters(Request Req, bool HideFormatPluginsGrid)
        {
            ...
            else
            {
                ...
                foreach (string Name in Req.Body.GetNames())
                {
                    ...
                    {
                        int RowId = BodyParametersGrid.Rows.Add(new object[] { Name, Value, Properties.Resources.Glass, Tools.Base64Encode(Value) });
                ...
                else
                {
                    ...
                    foreach (DataGridViewRow Row in BodyParametersGrid.Rows)
                    {
                        ...
                        else
                        {
                            try
                            {
                                EditedNameValuePairs[Row.Index, 1] = Tools.Base64Decode(Row.Cells[3].Value.ToString());
                            }
                            catch 
                            {
       ...
       void ResetBodyFormatXmlChangedStatus()
        ...
        private void BodyParametersGrid_CellValueChanged(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                BodyParametersGrid.Rows[e.RowIndex].Cells[3].Value = Tools.Base64Encode(BodyParametersGrid.Rows[e.RowIndex].Cells[1].Value.ToString());
            }
            catch { }
            if (DisplayedRequest != null && RequestChanged != null)
                RequestChanged();
        ...
        void SetDeserializedDataInUi(string PluginName, string XML, string[,] XmlNameValueArray)
        {
            ...
            else
            {
                ...
                {
                    int RowId = BodyParametersGrid.Rows.Add(new object[] { XmlNameValueArray[i, 0], Tools.Base64Decode(XmlNameValueArray[i, 1]), Properties.Resources.Glass, XmlNameValueArray[i, 1] });
                    BodyParametersGrid.Rows[RowId].Cells[1].ReadOnly = this.ReadOnly;
                }
                ShowBodyFormatOptions();
                this.ShowHideEmptyMessages();
        ...
        private void BodyParametersGrid_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.ColumnIndex == 2)
            {
                ...
                try
                {
                    SetEditTab(Tools.Base64DecodeToByteArray(BodyParametersGrid.Rows[e.RowIndex].Cells[3].Value.ToString()));
                }
                catch
                {
                    SetEditTab(BodyParametersGrid.Rows[e.RowIndex].Cells[3].Value.ToString());
                }
            }
        }
        ...
        void ShowHideEmptyMessages()
        {
            if (this.DisplayedRequest == null)
            {
                BodyTBP.Visible = true;
                UrlPathPartsParametersGrid.Visible = true;
                QueryParametersGrid.Visible = true;
                BodyParamsPanel.Visible = true;
                CookieParametersGrid.Visible = true;
                HeadersParametersGrid.Visible = true;

                BodyEmptyLbl.Visible = false;
                BodyAddLL.Visible = false;
                UrlPathPartsEmptyLbl.Visible = false;
                QueryParamEmptyLbl.Visible = false;
                BodyParamEmptyLbl.Visible = false;
                CookieParamEmptyLbl.Visible = false;
                HeaderParamEmptyLbl.Visible = false;
            }
            else
            {
                if (BodyTBP.Text.Length == 0)
                {
                    BodyTBP.Visible = false;
                    BodyEmptyLbl.Visible = true;
                    if (this.ReadOnly)
                    {
                        BodyAddLL.Visible = false;
                    }
                ...
                if(UrlPathPartsParametersGrid.Rows.Count == 0)
                {
                    UrlPathPartsParametersGrid.Visible = false;
                    UrlPathPartsEmptyLbl.Visible = true;
                }
                else
                {
                    UrlPathPartsParametersGrid.Visible = true;
                ...
                if (QueryParametersGrid.Rows.Count == 0)
                {
                    QueryParametersGrid.Visible = false;
                    QueryParamEmptyLbl.Visible = true;
                }
                else
                {
                    QueryParametersGrid.Visible = true;
                ...
                if (BodyTBP.Text.Length == 0)
                {
                    BodyParamsPanel.Visible = false;
                    BodyParamEmptyLbl.Visible = true;
                }
                else
                {
                    BodyParamsPanel.Visible = true;
                ...
                if (CookieParametersGrid.Rows.Count == 0)
                {
                    CookieParametersGrid.Visible = false;
                    CookieParamEmptyLbl.Visible = true;
                }
                else
                {
                    CookieParametersGrid.Visible = true;
                ...
                if (HeadersParametersGrid.Rows.Count == 0)
                {
                    HeadersParametersGrid.Visible = false;
                    HeaderParamEmptyLbl.Visible = true;
                }
                else
                {
                    HeadersParametersGrid.Visible = true;
        ...
        private void SaveEditsLbl_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            switch (ExpandedParameterSection)
            {
                ...
                case ("Query"):
                    ...
                    break;
                case("Body"):
                    string Name = BodyParametersGrid.Rows[ExpandedParameterIndex].Cells[0].Value.ToString();
                    ...
                    BodyParametersGrid.Rows.RemoveAt(ExpandedParameterIndex);
                    BodyParametersGrid.Rows.Insert(ExpandedParameterIndex, new object[] { Name, NormalValue, Properties.Resources.Glass, EncodedValue });
                    BodyParametersChanged = true;
        ...
        private void BodyAddLL_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            BodyEmptyLbl.Visible = false;
            BodyAddLL.Visible = false;
            BodyTBP.Visible = true;
