...
namespace IronWASP
{
    internal class IronLog
    {
        ...
        internal static List<LogRow> GetNextProxyLogRecords(int JumpLevel)
        {
            ...
            if (Records.Count == 0)
            {
                int NewStartIndex = (Config.LastProxyLogId / IronLog.MaxRowCount) * IronLog.MaxRowCount;
                if (NewStartIndex > 0)
                {
        ...
        internal static List<LogRow> GetNextProbeLogRecords(int JumpLevel)
        {
            ...
            if (Records.Count == 0)
            {
                int NewStartIndex = (Config.LastProbeLogId / IronLog.MaxRowCount) * IronLog.MaxRowCount;
                if (NewStartIndex > 0)
                {
        ...
        internal static List<LogRow> GetNextScanLogRecords(int JumpLevel)
        {
            ...
            if (Records.Count == 0)
            {
                int NewStartIndex = (Config.LastScanLogId / IronLog.MaxRowCount) * IronLog.MaxRowCount;
                if (NewStartIndex > 0)
                {
        ...
        internal static List<LogRow> GetNextShellLogRecords(int JumpLevel)
        {
            ...
            if (Records.Count == 0)
            {
                int NewStartIndex = (Config.LastShellLogId / IronLog.MaxRowCount) * IronLog.MaxRowCount;
                if (NewStartIndex > 0)
                {
        ...
        internal static List<LogRow> GetNextOtherLogRecords(int JumpLevel)
        {
            ...
            if (Records.Count == 0)
            {
                int NewStartIndex = (Config.GetLastLogId(IronLog.SelectedOtherSource) / IronLog.MaxRowCount) * IronLog.MaxRowCount;
                if (NewStartIndex > 0)
                {
        ...
        internal static List<LogRow> GetNextTestLogRecords(int JumpLevel)
        {
            ...
            if (Records.Count == 0)
            {
                int NewStartIndex = (Config.LastTestLogId / IronLog.MaxRowCount) * IronLog.MaxRowCount;
                if (NewStartIndex > 0)
                {
