...
namespace IronWASP
{
    public partial class ResponseView : UserControl
    {
        ...
        public void ClearResponse()
        {
            ...
            {
                ShowStatusMsg("Loading a Response is already in progress!");
            }
        }
        ...
        private void BodyFormatPluginsParametersGrid_CellValueChanged(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                BodyFormatPluginsParametersGrid.Rows[e.RowIndex].Cells[3].Value = Tools.Base64Encode(BodyFormatPluginsParametersGrid.Rows[e.RowIndex].Cells[1].Value.ToString());
            }
            catch { }
        ...
        void SetDeserializedDataInUi(string PluginName, string XML, string[,] XmlNameValueArray)
        {
            ...
            else
            {
                ...
                {
                    int RowId = BodyFormatPluginsParametersGrid.Rows.Add(new object[] { XmlNameValueArray[i, 0], Tools.Base64Decode(XmlNameValueArray[i, 1]), Properties.Resources.Glass, XmlNameValueArray[i, 1] });
        ...
        private void BodyFormatPluginsParametersGrid_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.ColumnIndex == 2)
            {
                ...
                SetEditTab(Tools.Base64DecodeToByteArray(BodyFormatPluginsParametersGrid.Rows[e.RowIndex].Cells[3].Value.ToString()));
            }
        }
        ...
        void ShowHideEmptyMessages()
        {
            if (this.DisplayedResponse == null)
            {
                ...
                BodyParametersTabSplit.Visible = true;
            ...
            else
            {
                ...
                if (BodyFormatPluginsParametersGrid.Rows.Count == 0)
                {
                    BodyParametersTabSplit.Visible = false;
