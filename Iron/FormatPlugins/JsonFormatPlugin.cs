                    ...
                    case(XmlNodeType.Text):
                        switch(ValType)
                        {
                            case("num"):
                                try
                                {
                                    JTW.WriteValue(Int32.Parse(Tools.Base64Decode(XR.Value.Trim())));
                                }
                                catch
                                {
                                    try
                                    {
                                        JTW.WriteValue(float.Parse(Tools.Base64Decode(XR.Value.Trim())));
                                    }
                                    catch
                                    {
                                        JTW.WriteValue(Tools.Base64Decode(XR.Value));
                                    }
                                }
                                break;
                            case("str"):
                                JTW.WriteValue(Tools.Base64Decode(XR.Value.ToString()));
                                break;
                            case("bool"):
                                if (Tools.Base64Decode(XR.Value).Equals("1"))
                                {
                                    JTW.WriteValue(true);
                                }
                                else if(Tools.Base64Decode(XR.Value).Equals("0"))
                                {
                                ...
                                break;
                            case("undef"):
                                if (Tools.Base64Decode(XR.Value.ToString()) == "null")
                                {
                                    JTW.WriteNull();
                                }
                                else
